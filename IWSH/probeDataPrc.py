...
case = {'NBL.prec.newdomain.56cores':0}

probeData = {} # original probeDataDict of all cases
probeData_ave = {}

f = open(projDir + 'postProcessing_all/' + 'NBL.prec.newdomain.56cores' + '_probeData', 'rb')
...
x = probeData_ave[caseNo][0:8,3]
y = probeData_ave[caseNo][0:8,2]
